...
def main():
    ...
    artifact_results = Path(__file__).resolve().parents[2] / "artifacts" / "results"
    rule_path = str(artifact_results / "vc_mcts_late_hi_rule_5seed.json")
    sas_path = str(artifact_results / "vc_mcts_late_hi_sas_5seed.json")
