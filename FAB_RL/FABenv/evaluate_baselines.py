...
if __name__ == "__main__":
    ...
    main(
        instance="pressure",
        seeds=5,
        checkpoint=os.path.join(HERE, "pressure_mh_hard.pt"),   # 新 3 通道重训模型 → SAS-PPO 贪心对比
        ...
        out=os.path.join(HERE, "results", "pressure_hard_v2.jsonl"),
        markdown_out=os.path.join(HERE, "results", "pressure_hard_v2_table.md"),
    )
